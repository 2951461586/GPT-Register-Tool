...
| Mailbox and phone inventory | `mailbox.py`, `mailbox_types.py`, `mailbox_parsers.py`, `providers/mailbox_*.py`, `providers/outlook_imap.py`, `mail_otp.py`, `smsbower.py`, `phone_reuse.py`, `phone_proxy.py`, `sms_provider.py` | Acquire/poll mailboxes or phone activations. All active mailbox provider implementations live under `sms_tool/providers/`; top-level `mailbox_*` files are compatibility facades only. Chongzhi was removed; unsupported legacy lines are skipped. |
