...
| Account liveness and recovery | `accounts/account_liveness.py`, `accounts/account_recovery.py`, `accounts/account_scan.py` | Canonical side-effect-free quota probe, explicit OAuth recovery/persistence, and batch account scan; does not switch Workspace state. |
