            ...
            Category("注册与接码",
                Section("注册驱动",
                    Options("registration_driver", "注册驱动", "registration.driver", "protocol",
                        "protocol", "playwright", "roxy", "cloak", "camoufox", "browser_use", "skyvern"),
                ...
                Section("RoxyBrowser",
                    Text("roxy_api_base", "本地 API 地址", "registration.drivers.roxy.api_base", "http://127.0.0.1:50100"),
                ...
                Section("Browser Use",
                    Secret("browser_use_api_key", "API Key", "registration.drivers.browser_use.api_key"),
                    Text("browser_use_cdp_base", "CDP 地址", "registration.drivers.browser_use.cdp_base", "wss://connect.browser-use.com"),
                    Text("browser_use_proxy_country", "代理国家代码", "registration.drivers.browser_use.proxy_country_code"),
                    Boolean("browser_use_proxy", "使用云代理", "registration.drivers.browser_use.use_proxy", true),
                    Text("browser_use_profile_id", "Profile ID", "registration.drivers.browser_use.profile_id"),
                    Integer("browser_use_session_timeout", "会话存活分钟", "registration.drivers.browser_use.session_timeout_minutes", "120"),
                    Boolean("browser_use_keep_open", "保留云端会话", "registration.drivers.browser_use.keep_browser_open", false)),
                Section("Skyvern",
                    Secret("skyvern_api_key", "API Key", "registration.drivers.skyvern.api_key"),
                    Text("skyvern_api_base", "API 地址", "registration.drivers.skyvern.api_base", "https://api.skyvern.com"),
                    Integer("skyvern_session_timeout", "会话存活分钟", "registration.drivers.skyvern.session_timeout_minutes", "60"),
                    Text("skyvern_profile_id", "Profile ID", "registration.drivers.skyvern.profile_id"),
                    Text("skyvern_proxy_location", "代理地区", "registration.drivers.skyvern.proxy_location"),
                    Boolean("skyvern_generate_profile", "生成浏览器 Profile", "registration.drivers.skyvern.generate_browser_profile", false),
                    Boolean("skyvern_ad_blocker", "启用广告拦截", "registration.drivers.skyvern.ad_blocker", true),
                    Options("skyvern_browser_type", "浏览器类型", "registration.drivers.skyvern.browser_type", "stealth-chromium",
                        "stealth-chromium", "chromium", "msedge"),
                    Boolean("skyvern_keep_open", "保留云端会话", "registration.drivers.skyvern.keep_browser_open", false)),
                Section("SMSBower",
