        ...
        public static IReadOnlyList<SettingsCategoryDefinition> Categories { get; } = new[]
        {
            ...
            Category("注册与接码",
                ...
                Section("脉冲调度",
                    ...
                    Boolean("pulse_canary_enabled", "首波与阻断后单账号探针", "registration.pulse.canary_enabled", true),
                ...
                Section("跨批重试",
                    Integer("registration_cross_batch_cooldown", "跨批冷却秒", "registration.retry_policy.cross_batch_cooldown_seconds", "1800"),
                    Integer("registration_otp_pending_quarantine", "OTP挂起隔离阈值", "registration.retry_policy.otp_pending_quarantine_threshold", "2")),
                Section("浏览器进程池",
            ...
            Category("网络与支付",
                Section("基础网络",
                    ...
                    Multiline("mailbox_proxy_pool", "邮箱收件代理池（网络异常时自动切换）", "")),
                Section("协议管理",
